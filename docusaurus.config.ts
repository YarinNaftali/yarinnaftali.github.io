...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/YarinNaftali/yarinnaftali.github.io/tree/main/',
        },
        blog: {
          showReadingTime: true,
          readingTime: ({content, frontMatter, defaultReadingTime}) =>
            defaultReadingTime({content, frontMatter, options: {wordsPerMinute: 200}}),
          editUrl: 'https://github.com/YarinNaftali/yarinnaftali.github.io/tree/main/',
          blogTitle: 'בלוג',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Yarin Naftali. Built with Docusaurus.`,
    },
    prism: {
